...
const MenuButton = ({ children }:{children:React.ReactNode}) => (
  <button type="button" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-300">
    {children}
  </button>
);
...
const Navbar = () => {
  ...
  return (
    <header className="flex  justify-between items-center px-20 py-3 w-full text-lg font-semibold text-black whitespace-nowrap bg-orange-900 sm:flex-wrap sm:px-5 sm:max-w-full">
