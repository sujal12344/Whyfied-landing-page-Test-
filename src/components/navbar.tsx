...
const Navbar = () => {
  ...
  return (
    <header className="flex  justify-between items-center px-20 mb:px-0 py-3 w-full text-lg font-semibold text-black whitespace-nowrap bg-orange-200 smToLarge:flex-wrap smToLarge:px-5 smToLarge:max-w-full">
