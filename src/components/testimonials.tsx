  ...
  return (
    <div className="h-full bg-orange-100 2xl:pt-[200px]">
      ...
      <div className="flex flex-col mdToLarge:grid mdToLarge:grid-cols-12">
        <div className="pt-[60px] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[80px] 2xl:text-[90px] w-full mdToLarge:col-span-4 md:pt-[13vh] lg:pt-[13vh] xl:pt-[11vh] 2xl:pt-[16vh] font-black text-center mdToLarge:text-start mdToLarge:ml-[8vw] mdToLarge:leading-normal lg:leading-tight 2xl:leading-normal text-yellow-500 px-1 h-fit">
        ...
        <div className="flex flex-col space-y-[4vh] sm:space-y-[6vh] pt-[5vh] sm:pt-[6vh] mdToLarge:pt-[14vh] 2xl:pt-[15vh] items-center mdToLarge:col-span-8 pb-20">
          <div className="scale-75 hover:scale-[0.82] mb:scale-[0.70] mb:hover:scale-[0.79] sm:scale-[0.8] sm:hover:scale-[0.85] md:scale-75 md:hover:scale-[0.82] lg:scale-[0.8] lg:hover:scale-[0.85] xl:scale-[0.85] xl:hover:scale-[0.90] 2xl:scale-[0.95] 2xl:hover:scale-100 z-20">
            ...
            <img
              ...
              alt="image"
              className="h-[100px] w-[100px] relative bottom-[365px] left-[-50px]"
            />
          </div>
          ...
          <div className="flex items-center justify-center scale-75 hover:scale-[0.82] mb:scale-[0.70] mb:hover:scale-[0.79] sm:scale-[0.8] sm:hover:scale-[0.85] md:scale-75 md:hover:scale-[0.82] lg:scale-[0.8] lg:hover:scale-[0.85] xl:scale-[0.85] xl:hover:scale-[0.90] 2xl:scale-[0.95] 2xl:hover:scale-100 relative bottom-[160px]">
          ...
          <div className="scale-75 hover:scale-[0.82] mb:scale-[0.70] mb:hover:scale-[0.79] sm:scale-[0.8] sm:hover:scale-[0.85] md:scale-75 md:hover:scale-[0.82] lg:scale-[0.8] lg:hover:scale-[0.85] xl:scale-[0.85] xl:hover:scale-[0.90] 2xl:scale-[0.95] 2xl:hover:scale-100 relative bottom-[220px]">
            <Card
